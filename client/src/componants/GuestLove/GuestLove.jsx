...
const GuestLove = () => {
  const { data, loading, err } = useFetch(
    "https://full-stack-hotel-booking-app-eosin.vercel.app/api/hotels?featured=true&limit=4"
  );

  return (
    <div className="my-6">
      <div className="container mx-auto px-6">
        <h3 className="text-2xl font-bold mb-6">Homes guests love</h3>
                ...
                <div className="desc flex flex-col space-y-2">
                  ...
                  {hotel.rating && (
                    <div className="reviewsSection">
                      <span className="bg-orange-700 text-white px-2 rounded-md py-1">
                        {" "}
                        {hotel.rating}
                      </span>
                      <span className="text-sm text-gray-600">
                        {" "}
                        Exellent- 4857 reviews
                      </span>
                    </div>
                  )}
                </div>
